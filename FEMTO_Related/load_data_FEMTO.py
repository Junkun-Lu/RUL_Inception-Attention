...
def train_test_generator_FEMTO(pre_process_type, train_root_dir, train_bearing_data_set, test_root_dir, test_bearing_data_set, STFT_window_len, STFT_overlap_num, window_length, validation_rate):
